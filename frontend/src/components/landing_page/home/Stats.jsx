...
export default function Stats() {
    return (
        <div className="contianer p-3 mb-5">
            <div className="row p-5">
                ...
                <div className="col p-5">
                    ...
                    <div>
                        <a href="#" className="mx-5" style={{textDecoration:"none"}}>Explore Products <i className="fa fa-long-arrow-right" aria-hidden="true"></i></a>
